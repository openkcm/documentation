...
### Mermaid Diagram — Color-Coded Keychain Flow
...
flowchart TD
    ...
    %% Styles
    classDef green fill:#b7f7b7,stroke:#2d7a2d,stroke-width:2px,color:#fff;
    classDef red fill:#f7b7b7,stroke:#7a2d2d,stroke-width:2px,color:#fff;
```
