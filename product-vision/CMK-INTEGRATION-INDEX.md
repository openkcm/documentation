...
| :--- | :--- | :--- | :--- |
| [Key Management Scenarios: Krypton-Managed vs. Customer-Managed](openkcm-key-management-scenarios.md) | Two scenarios for L1 key ownership — what customers get with Krypton-managed keys vs. BYOK/HYOK, and where the CMK controller scope begins | Product, Engineering, Customer-facing teams | 5 min |
